...
with tarfile.open(tar_path, mode="w:gz") as archive:
    ...
    archive.add(os.path.join(model_dir, "inference.py"), arcname="inference.py")

assert os.path.exists(tar_path), "model.tar.gz not created!"
print("Model and inference script packaged correctly.")
